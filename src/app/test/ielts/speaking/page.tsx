...
export default function SpeakingTestPage() {
    ...
    const handleClick = (testId: string) => {
        router.push(`/test/ielts/speaking/${testId}`);
    };
    ...
    return (
        ...
        <main className="p-8">
            <h1 className="text-2xl font-bold mb-6">Speaking Tests</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    <h2 className="text-xl font-semibold mb-2 text-amber-500">Speaking Test {index + 1}</h2>
                    <p className="text-sm text-gray-600">
                    Click to begin Speaking Test {index + 1}
                    </p>
                </div>
                ))}
            </div>
