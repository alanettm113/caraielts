    ...
    const taskContentMap: Record<'task1' | 'task2', {
        ...
        setShowNote: (v: boolean) => void;
            ...
            <div className="space-y-2">
                ...
                <div className="border px-4 py-2 bg-white font-semibold">
                <p>
                Some people believe that working from home is beneficial for employees, 
                while others argue that it can be detrimental to work efficiency. 
                Discuss the advantages and disadvantages of working from home.</p>
                </div>
                <p>
