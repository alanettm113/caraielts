...
export default function WritingTestPage() {
    ...
    const handleClick = (testId: string) => {
        router.push(`/test/ielts/writing/${testId}`); // Updated route
    };
    ...
    return (
        ...
        <main className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    <h2 className="text-xl font-semibold mb-2 text-amber-500">Writing Test {index + 1}</h2>
                    <p className="text-sm text-gray-600">
                    Click to begin Writing Test {index + 1}
                    </p>
                </div>
                ))}
            </div>
