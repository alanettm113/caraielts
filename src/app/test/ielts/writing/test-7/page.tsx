    ...
    const taskContentMap: Record<'task1' | 'task2', {
        ...
        setShowNote: (v: boolean) => void;
            ...
            <div>
                ...
                types of accommodation in three different years. Summarize the information by
                selecting and reporting the main features and comparisons where relevant.</p>
                <p className="text-md font-semibold py-2"> Write at least 150 words. 
                </p>
                <img
                    src="/images/Writing_Test7_Task1.png"
                    alt="WRITING TASK1 IMAGE"
                    className="mt-2 w-full max-w-full h-auto border rounded shadow"
                />
            </div>
            ),
            essay: task1,
            ...
            <div className="space-y-2">
                ...
                <p>
                What are the advantages and disadvantages of studying online instead of attending school or university in person?
                </p>
                </div>
                <p>
